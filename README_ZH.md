...
- ### 包管理
  ...
  Linux用户建议优先直接使用 PyPI 官方依赖；如果托盘图标没有显示，可以先尝试：
  ...
  部分 Linux 桌面环境还需要额外安装 `python3-gi`。  
...
- 上游最新正式版是 [v0.7（2022 年 1 月 13 日）](https://github.com/xfangfang/Macast/releases/tag/v0.7)。
- 这个分支将运行时基线提升到 Python 3.10，以便在 2026 年仍能安装当前可用的依赖版本。
